...
#define MVPP2_SKB_SHINFO_SIZE \
	0
// XXX: SKB_DATA_ALIGN(sizeof(struct skb_shared_info))

#define MVPP2_RX_PKT_SIZE(mtu) \
	ALIGN((mtu) + MVPP2_MH_SIZE + MVPP2_VLAN_TAG_LEN + \
	      ETH_HLEN + ETH_FCS_LEN, cache_line_size())

#define NET_SKB_PAD 0 // XXX
...
struct mvpp2 {
	/* FreeBSD resources are used instead of raw addresses */
	struct resource *base_res;
	struct resource *iface_base_res;
